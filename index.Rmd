...
The tutorial assumes you have used R before. Many of the examples and demos utilize functions from the **Tidyverse** [@R-tidyverse]. This tutorial was written using the **bookdown** package [@R-bookdown], which was built on top of R Markdown and **knitr** [@xie2015].
