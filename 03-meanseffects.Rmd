...
decorate("meansmodel-compute") %>% 
  ...
  flair("ss_tot", background = "blue") %>% 
  flair("ss_trt", background = "blue") %>% 
  flair("ss_error", background = "blue") %>% 
...
2. Our `r colorize("SS values", "blue")` are computed using matrix operations carrying out the equations described in \@ref(bookkeep). For brevity I will not describe the operations in detail.
...
Will one of the two data sets produce a larger F-statistic (Scenario 1 or Scenario 2)? Why or  why not.
