...
The answer to the above question can be answered by thinking about **power**. Power is the probability that we reject our null hypothesis when in fact the null hypothesis is actually false. To make sense of this recall the Type I error and Type II error rates from introductory statistics:
